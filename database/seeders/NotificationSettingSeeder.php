...
class NotificationSettingSeeder extends Seeder
{
    public function run(): void
    {
        $rows = [
            ...
            [
                'key' => 'monthly_close',
                'label_ar' => 'إغلاق الشهر',
                'label_en' => 'Month Close',
                'description_ar' => 'إنشاء سجل إغلاق دائم للشهر المنصرم وتجميد الميزانية. يجب أن يسبق التقرير الشهري.',
                'description_en' => 'Builds the immutable end-of-month snapshot and locks the budget. Must run before the monthly report.',
                'command' => 'waffer:close-month',
                'schedule_time' => '02:00',
            ...
            [
                'key' => 'goal_pace_check',
                'label_ar' => 'مراقبة تقدّم الأهداف',
                'label_en' => 'Goal Pace Check',
                'description_ar' => 'يفحص كل هدف ادخار نشط ويصدر تنبيهًا للأهداف المتأخرة عن الخطة (مرّة واحدة كل شهر).',
                'description_en' => 'Walks every active saving goal and alerts when one falls behind plan (deduped monthly).',
                'command' => 'waffer:goal-pace-check',
                'schedule_time' => '10:00',
                'schedule_frequency' => 'monthly',
                'schedule_day_of_month' => 1,
                'extra_config' => null,
